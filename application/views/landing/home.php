  ...
  <div class="container">
    ...
    <div class="row align-items-center text-center text-md-left">
      ...
      <div class="col-md-6 col-lg-7 col-xl-6 offset-xl-1">
        <img class="img-fluid" src="<?= base_url('assetsL/img/home/hero-img.png'); ?>" alt="">
      </div>
    </div>
  </div>
</section>
      ...
      <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
        <div class="service-card text-center">
          <div class="service-card-img">
            <img class="img-fluid" src="<?= base_url('assetsL/img/home/service1.png'); ?>" alt="">
          </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-7 col-md-6 mb-4 mb-md-0">
        <div class="about-img">
          <img class="img-fluid" src="<?= base_url('assetsL/img/home/about-img.png'); ?>" alt="">
        </div>
      </div>
          ...
          <div class="tour-card-overlay">
            <div class="media">
              ...
              <div class="media-price">
                <h4 class="text-primary">375k/day</h4>
              </div>
            </div>
          </div>
        </div>
...
<section class="section-margin">
  ...
  <div class="section-intro text-center pb-90px">
    ...
    <img class="section-intro-img" src="<?= base_url('assetsL/img/home/section-icon.png'); ?>" alt="">
    <h2>Persebaran Hotel Terbaik di Pekanbaru</h2>
    <p>Peta Persebaran Hotel Terbaik menurut</p>
  </div>
  <div class="container">
...
<section class="section-padding bg-gray">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
        <div class="card-blog">
          <img class="card-img rounded-0" src="<?= base_url('assetsL/img/blog/blog-1.png'); ?>" alt="">
      ...
      <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
        <div class="card-blog">
          <img class="card-img rounded-0" src="<?= base_url('assetsL/img/blog/blog-2.png'); ?>" alt="">
          <div class="card-blog-body">
            <a href="#">
              <h4>Forest responds to consultation smoking in al fresco.</h4>
            </a>
      ...
      <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
        <div class="card-blog">
          <img class="card-img rounded-0" src="<?= base_url('assetsL/img/blog/blog-3.png'); ?>" alt="">
          <div class="card-blog-body">
            <a href="#">
              <h4>Forest responds to consultation smoking in al fresco.</h4>
            </a>
